...
- `tasks/` — eight capability task directories (`log_cardio`, `log_yoga`, `log_routine_workout`, `update_cardio`, `update_yoga`, `update_routine_workout`, `report_workout`, `analyze_workout`) each supplying JSON schemas, SQL templates, and example responses.
