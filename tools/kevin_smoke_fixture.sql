...
INSERT INTO kevin_workouts (date, cardio_minutes, cardio_type, yoga_done, yoga_type, routine_completed, corrected, record_id)
VALUES
  (current_date, 30, 'run', FALSE, NULL, FALSE, 0, 'cardio-smoke-1'),
  (current_date - INTERVAL '1 day', 25, 'bike', FALSE, NULL, FALSE, 0, 'cardio-smoke-2'),
  (current_date - INTERVAL '1 day', NULL, NULL, TRUE, 'vinyasa', FALSE, 0, 'yoga-smoke-1'),
  (current_date - INTERVAL '1 day', NULL, NULL, FALSE, NULL, TRUE, FALSE, 'routine-smoke-1');
